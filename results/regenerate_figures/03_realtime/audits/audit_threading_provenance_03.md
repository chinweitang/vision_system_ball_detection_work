...
Read-only. No figures. Generated 2026-08-24 20:49 by `src/regen_2class/audit_threading_provenance_03.py`.

**Gate result: FAIL** (19 of 20 checks pass).
...
| G3 | summary.txt carries recomputed p99=15.401 | **FAIL** |
